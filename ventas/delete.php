                            ...
                            <script>
                                $('#btn_borrar_venta').click(function() {
                                    ...
                                    function actualizar_stock() {
                                        var i = 1; // Inicializa el contador
                                        var n = '<?php echo $contador_de_carrito; ?>'; // Obtiene el número total de productos desde PHP
                                        ...
                                        for (i = 1; i <= n; i++) {
                                            ...
                                            // $.get(url2, { id_producto: id_producto, stock_calculado: stock_calculado }, function(datos) 1  {
                                            //     // ...
                                            // });
                                        }
                                    }
                                    ...
                                    function borrar_venta() {
                                        console.log("borrar_venta llamada");
