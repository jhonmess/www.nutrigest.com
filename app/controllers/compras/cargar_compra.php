...
$sql_compras = "SELECT *, co.precio_compra as precio_compra, 
                ...
                FROM compras as co 
                INNER JOIN almacen as pro ON co.id_producto = pro.id_producto 
                ...
                INNER JOIN proveedores as prov ON co.id_proveedor = prov.id_proveedor WHERE co.id_compra = '$id_compra_get' ";
