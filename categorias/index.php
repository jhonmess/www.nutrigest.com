                        ...
                        <td>
                          <center>
                            <div class="btn-group">
                              ...
                              <d class="modal fade" id="modal-update<?php echo $id_categoria; ?>">
                                        ...
                                        <div class="col-md-12">
                                          <div class="form-group">
                                            ...
                                            <small style="color: red; display: none;"
                                              id="lbl_update<?php echo $id_categoria; ?>">* Este campo es
                                              requerido</small>
                                          </div>
                                ...
                                <script>
                                  $('#btn_update<?php echo $id_categoria; ?>').click(function () {
                                    ...
                                    $.get(url, { nombre_categoria: nombre_categoria, id_categoria: <?php echo $id_categoria; ?> }, function (datos) {
